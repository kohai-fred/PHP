...
// Connexion à la BDD :
$pdo = new PDO('mysql:host=localhost;dbname=site',  // driver MySQL, nom du serveur, nom de la BDD
...
define('RACINE_SITE', '/PHP/09-site/');  // ici on indique le dossier dans lequel se trouve le site à partir de "localhost". S'il n'est dans un aucun dossier, on met un "/" seul. Permet de créer des chemins absolus à partir de "localhost" utilisés notamment dans le "header.php" qui est inclus dans des pages qui se trouvent dans différents sous-dossiers du site. Par conséquent, les chemins relatifs vers les sources changent selon ces sous-dossiers, ce qui n'est pas le cas en chemin absolu.
