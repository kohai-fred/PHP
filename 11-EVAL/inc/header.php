...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-secondary">
            <a class="navbar-brand text-danger font-weight-bold" href="<?php echo RACINE_SITE . 'index.php';  ?>">IMMO</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link text-warning" href="<?php echo RACINE_SITE . 'gestion_bien.php';  ?>">Gestion des biens <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
